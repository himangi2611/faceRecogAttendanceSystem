...
def speak_async(str1):
    threading.Thread(target=speak, args=(str1,)).start()

def send_email(attachment_path):
    sender_email = "himangisharma2002@gmail.com"  
    sender_password = "eyea uvpr wjik inxj"  
    receiver_email = "himangi1126@gmail.com" 
...
def add_attendance(name):
    ...
    if int(userid) not in list(df['Roll']):
        ...
        speak_async("Attendance Taken")

        attendance_file_path = f'Attendance/Attendance-{datetoday}.csv'
        threading.Thread(target=send_email, args=(attendance_file_path,)).start()
